            ...
            < div className="min-h-dvh flex " >
                ...
                <div className="md:m-10 md:p-10 md:max-w-[45%] flex flex-col text-white p-5 m-3">
                    ...
                    <div className="md:ml-0 mt-10 mx-auto font-semibold flex gap-4 text-center">
                        ...
                        <Link href="#booking" className="mt-10 mx-auto p-5 text-white font-semibold bg-linear-to-r from-purple-400 via-purple-500 to-purple-600 hover:bg-linear-to-br rounded-3xl hover:opacity-90 transition-opacity">Book services</Link>
                    </div>
