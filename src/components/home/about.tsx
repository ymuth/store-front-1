                    ...
                    <div className="row-span-2 md:col-[4/-1] md:row-[2/-1] overflow-x-clip">
                        ...
                        <FadeIn x={80} y={0}>
                            <div className=" relative z-10 md:shadow-[-20px_10px_40px_rgba(0,0,0,0.45)] md:text-left text-center text-white justify-center flex flex-col bg-[#5b5a5a] overflow-hidden px-5 py-10 md:p-15  ">
                                ...
                                <Link aria-label="About Page" href="/about" className="mt-10 mx-auto p-5 text-white font-semibold bg-linear-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-linear-to-br rounded-3xl hover:opacity-90 transition-opacity">More About Us</Link>
