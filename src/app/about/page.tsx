            ...
            <div className="font-poppins relative w-full flex flex-col ">
                ...
                <div className="md:m-10 md:p-10 md:max-w-[45%] flex flex-col text-white p-5 m-3">
                    ...
                    <div className="md:ml-0 mx-auto font-semibold grid md:grid-cols-3 grid-cols-2 gap-4 text-center">
                        ...
                        <Link href="/#booking" className="md:col-auto col-span-2 w-full mx-auto p-5 text-white font-semibold bg-linear-to-r from-amber-400 via-amber-500 to-amber-600 hover:bg-linear-to-br rounded-3xl hover:opacity-90 transition-opacity">Book services</Link>
                    </div>
